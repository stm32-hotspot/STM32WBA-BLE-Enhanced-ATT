...
#define CFG_DEV_ID_BLE_EATT                  (0xE1)
/* USER CODE END PD */
...
/* USER CODE BEGIN EV */
extern uint8_t Notification_Data_Buffer[DATA_NOTIFICATION_MAX_PACKET_SIZE];
/* USER CODE END EV */
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          HandleNotification.CoC_EATT_Evt_Opcode = BLE_CONN_HANDLE_EVT;
          COC_EATT_CENTRAL_APP_Notification(&HandleNotification);
    ...
    case HCI_VENDOR_SPECIFIC_DEBUG_EVT_CODE:
    {
      ...
      switch (p_blecore_evt->ecode)
      {
        ...
        case ACI_GAP_PAIRING_COMPLETE_VSEVT_CODE:
        {
          ...
          HandleNotification.CoC_EATT_Evt_Opcode = BLE_PAIRING_COMPLETE_EVT;
          COC_EATT_CENTRAL_APP_Notification(&HandleNotification); 
      ...
      switch (ad_type)
      {
        ...
        case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:          
          if ((ad_length >= 7) && (p_adv_data[i + 4] == 0x02))
          {
            ...
            if(p_adv_data[i + 6] == CFG_DEV_ID_BLE_EATT)
            {
              ...
              LOG_INFO_APP("-- EATT peripheral detected, db addr 0x%02X:%02X:%02X:%02X:%02X:%02X\n",
          ...
          else if ((ad_length >= 7) && (p_adv_data[i + 2] == 0x01))
          {
            ...
            if(p_adv_data[i + 3] == CFG_DEV_ID_BLE_EATT)
            {
              ...
              LOG_INFO_APP("-- EATT peripheral, db addr 0x%02X:%02X:%02X:%02X:%02X:%02X\n",
                              bleAppContext.a_deviceServerBdAddr[5],
                              bleAppContext.a_deviceServerBdAddr[4],
                              bleAppContext.a_deviceServerBdAddr[3],
                              bleAppContext.a_deviceServerBdAddr[2],
