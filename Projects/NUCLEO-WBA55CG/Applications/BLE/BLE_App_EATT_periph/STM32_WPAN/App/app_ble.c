...
typedef struct
{
  ...
  uint16_t EATT_Bearer1_connHdl;
  uint16_t EATT_Bearer2_connHdl;
...
SVC1_APP_ConnHandleNotEvt_t SVC1HandleNotification;

static char a_GapDeviceName[] = {  'E', 'A', 'T', 'T', ' ', 'P', 'e', 'r', 'i', 'p', 'h', 'e', 'r', 'a', 'l' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[25] =
{
  8, AD_TYPE_COMPLETE_LOCAL_NAME, 'E', 'A', 'T', 'T', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      SVC1HandleNotification.EvtOpcode = SVC1_DISCON_HANDLE_EVT;
      SVC1HandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      SVC1_APP_EvtRx(&SVC1HandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SVC1HandleNotification.EvtOpcode = SVC1_CONN_HANDLE_EVT;
          SVC1HandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          SVC1_APP_EvtRx(&SVC1HandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          SVC1HandleNotification.EvtOpcode = SVC1_CONN_HANDLE_EVT;
          SVC1HandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          SVC1_APP_EvtRx(&SVC1HandleNotification);
...
static void Ble_Hci_Gap_Gatt_Init(void)
{
  ...
  ret = aci_hal_write_config_data(0x35,
                                  1,
                                  &Value);
  if (ret != BLE_STATUS_SUCCESS)
  {
    APP_DBG_MSG("  Fail   : aci_hal_write_config_data command - DBG_CMD, result: 0x%02X\n", ret);
  }
  else
  {
    APP_DBG_MSG("  Success: aci_hal_write_config_data command - DBG_CMD\n");
  }
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_EATT_PERIPH; /* FW ID */
